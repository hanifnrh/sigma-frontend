...
import { ButtonProps, buttonVariants } from "@/components/ui/buttons/button-pagination"
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    className={cn("flex flex-row items-center justify-center gap-3", className)}
    {...props}
  />
))
...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    size="default"
    className={cn("w-full gap-1 p-2.5", className)}
    {...props}
  >
