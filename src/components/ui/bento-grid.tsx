...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        "grid w-5/6 sm:w-4/6 auto-rows-[22rem] grid-cols-3 gap-4",
        className,
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  >
    <div>{background}</div>
    <div className="text-neutral-800 pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
