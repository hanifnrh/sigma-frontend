                        ...
                        <DropdownMenuTrigger asChild>
                            <div className="flex items-center border-l ml-3 pl-5 gap-2 cursor-pointer">
                                <div className="flex items-center font-semibold text-base gap-2">
                                    <p className="font-semibold bg-purple-100 dark:bg-purple-950 text-purple-600 dark:text-purple-400 rounded-md px-3 flex justify-center items-center">
                                        {role}
                                    </p>
                                    <p className="">
                        ...
                        <DropdownMenuTrigger asChild>
                            <div className="flex items-center gap-2 cursor-pointer">
                                <div className="flex items-center body text-base gap-2">
                                    <p className="font-semibold bg-emerald-100 dark:bg-purple-950 text-purple-600 dark:text-purple-400 rounded-md px-3 flex justify-center items-center">
                                        {role}
                                    </p>
                                    <p className="">
                                        {(fullName?.split(" ")[0]) || username || "User"}
