        ...
        <main className="w-full bg-white dark:bg-zinc-900 relative">
            ...
            <div className='flex flex-col mt-10 sm:mt-0 sm:pl-44 md:pl-56 xl:pl-64 w-full'>
                ...
                <div className="flex flex-col gap-4 w-full h-full p-4">
                    ...
                    <section>
                        <h2 className="w-fit flex items-center gap-2 text-lg body bg-violet-100 text-violet-800 px-4 py-2 rounded-md mt-6">
                            <LayoutDashboard />
                            Dasbor
                        </h2>
                        <h3 className="w-fit text-base body mt-6">
                            Fungsi Dasbor
                        </h3>
                        ...
                        <h3 className="w-fit text-base body rounded-md mt-6">
                            Penggunaan Dasbor
                        </h3>
                        <ul className="list-disc list-inside body-light">
