                                    ...
                                    <div className='flex flex-col justify-start items-start w-full xl:w-48 h-full'>
                                        <Dialog open={harvestDialogOpen} onOpenChange={setHarvestDialogOpen}>
                                            ...
                                            <DialogContent>
                                                ...
                                                <DialogClose asChild>
                                                    <Button type="button" className="bg-red-100 dark:bg-red-950 text-red-600 dark:text-red-400 border-red-300 dark:border-red-600 hover:bg-red-200 dark:hover:bg-red-900 transition-all">
                                                        Tutup
                                                    </Button>
                                                </DialogClose>
                                            </DialogContent>
                                ...
                                <div className='w-full grid grid-cols-2 justify-end items-start gap-2'>
                                    ...
                                    <div className='border border-indigo-200 dark:border-indigo-600 bg-indigo-100 dark:bg-indigo-950 dark:hover:bg-indigo-900 hover:bg-indigo-200 transition-all rounded-xl px-4 py-2 font-semibold text-sm sm:text-base'>
                                        {editMode ? (
                                            ...
                                            <>
                                                <div
                                                    className="text-indigo-600 dark:text-indigo-400 flex justify-between items-center cursor-pointer"
